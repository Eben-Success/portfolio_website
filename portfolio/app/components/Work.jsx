  ...
  return (
    <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
      ...
      <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
        Work on AI/ML tasks. I do problem solving on leetcode as well.
      </p>
      ...
      <div className="grid grid-cols-auto gap-5 my-10 dark:text-black">
        {workData.map((project, index) => (
          ...
          >
            ...
            bottom-5 left-1/2 -translate-x-1/2 py-3 px-5 flex 
            ...
            >
              ...
              <div
               ...
               flex items-center justify-center shadow-[2px_2px_0_#000] group-hover:bg-lightHover transition"
              >
      ...
      <a target="_blank"
        href="https://github.com/Eben-Success?tab=repositories"
